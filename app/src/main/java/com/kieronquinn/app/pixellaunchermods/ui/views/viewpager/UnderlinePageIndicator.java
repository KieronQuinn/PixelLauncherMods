 ...
 *
 * Converted from https://github.com/JakeWharton/ViewPagerIndicator to support ViewPager2
 */
public class UnderlinePageIndicator extends View implements BasePageIndicator {
    ...
    private final PageIndicator pageIndicator = new PageIndicatorImpl();
    ...
    public void setViewPager(ViewPager2 view) {
        pageIndicator.setViewPager(view);
    }

    @Override
    public void setViewPager(ViewPager2 view, int initialPosition) {
        pageIndicator.setViewPager(view, initialPosition);
    }

    @Override
    public void setCurrentItem(int item) {
        pageIndicator.setCurrentItem(item);
    }
    ...
    private class PageIndicatorImpl extends PageIndicator {
        ...
        public void onPageScrolled(int position, float positionOffset, int positionOffsetPixels) {
            ...
            if (mFades) {
                if (positionOffsetPixels > 0) {
                    removeCallbacks(mFadeRunnable);
                    mPaint.setAlpha(0xFF);
                } else if (mScrollState != ViewPager2.SCROLL_STATE_DRAGGING) {
